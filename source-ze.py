...
import time 
elhypamody = '5951674553'
bot = telebot.TeleBot(Config.TG_BOT_TOKEN)
p3 = types.InlineKeyboardMarkup()
p5 = types.InlineKeyboardButton(text = "𓆩ՏøuƦcε κα†ψα𓆪",url="t.me/Source_katya")
...
*لا يمكنك ارسال الروابط*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == "المطور" or m == "مطور" or m == "المبرمج":
		p3 = types.InlineKeyboardMarkup()
		e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/Ve_G4")
		p3.add(e4)
		h = """[مطور السورس .](t.me/Ve_G4)"""
...
نوع الحيوان : {}*""".format(f2,t2,r222,d222),disable_web_page_preview=True,parse_mode="markdown")
	if message.text == "السورس" or message.text == "سورس":
	    url = ["https://telegra.ph/file/d611842a0cee1884f725d.jpg","https://telegra.ph/file/abe004bdb4757bf336225.jpg","https://telegra.ph/file/af778e71176ac74a8fd00.jpg","https://telegra.ph/file/d611842a0cee1884f725d.jpg"]
	    p3 = types.InlineKeyboardMarkup()
	    e3 = types.InlineKeyboardButton(text = "قناة السورس .",url="t.me/Source_katya")
	    e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/Ve_G4")
	    p3.add(e3,e4)
	    r = random.choice(url)
	    h = """اهلا بك عزيزي في سورس الشبح
[قناة السورس .](t.me/Source_katya)
[مطور السورس .](t.me/Ve_G4)"""
...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "𓆩ՏøuƦcε κα†ψα𓆪",url="t.me/Source_katya")
	p3.add(p5)
...
- - - -- - - - - -- - - - -
CH - @Source_katya*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "𓆩ՏøuƦcε κα†ψα𓆪",url="t.me/Source_katya")
	p3.add(p5)
